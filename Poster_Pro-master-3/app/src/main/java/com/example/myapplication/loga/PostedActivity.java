...
public class PostedActivity extends AppCompatActivity {
    private static final String TAG = "Postactvity";
    private RecyclerView recyclerView;
    private MyAdapter adapter;
    private ArrayList<Event> eventArrayList;
    private TextView noItemText;
    private ImageButton poback;
    public Integer uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        poback = findViewById(R.id.poback);
        poback.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        noItemText = findViewById(R.id.noItemText2);
    ...
    private void createListData() {
            ...
            String query = "select * from p_a_post " + "where puid = " + uid;
